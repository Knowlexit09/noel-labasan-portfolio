 ...
 * because it extends the recovery-code fallback with a 24-hour email flow.
...
(function loadAdminEnhancements(){
  ...
  ['admin-enhancements.css','admin-resume-manager.css','admin-inbox.css','admin-security.css','admin-mfa.css','admin-recovery.css','admin-emergency-recovery.css'].forEach(file => {
  ...
  ['admin-enhancements.js','admin-list-manager.js','admin-resume-manager.js','admin-inbox.js','admin-contact-settings.js','admin-security.js','admin-mfa.js','admin-mfa-renderer.js','admin-recovery.js','admin-emergency-recovery.js','admin-revision-fix.js'].forEach(file => {
